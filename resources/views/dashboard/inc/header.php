      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="<?= url('profile?user_id='.$user?->id);?>">
            ...
            <li>
              <a onclick="return confirm('Are you sure to delete your account?')" class="dropdown-item d-flex align-items-center" href="<?= url('/user-delete?user_id='.$user?->id) ?>">
